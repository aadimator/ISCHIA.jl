...
function find_differentially_cooccurring_LR_pairs(
	cooc_df_1::DataFrame,
	cooc_df_2::DataFrame,
	group1_max_pval::Real,
	group2_min_pval::Real,
)
...
function find_differentially_cooccurring_LR_pairs(
	...
	group2_results::Dict{String, Any},
	group1_max_pval::Real,
	group2_min_pval::Real,
)
	...
	return find_differentially_cooccurring_LR_pairs(cooc_results_group1, cooc_results_group2, group1_max_pval, group2_min_pval)
end
